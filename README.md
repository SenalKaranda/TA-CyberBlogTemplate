...
## Step 3:
### Open the extracted folder, and edit the ```Index.html```, ```About.html```, and ```Contact.html``` using the content from your old blog
### Don't forget to add your images to ```assets/images/```
